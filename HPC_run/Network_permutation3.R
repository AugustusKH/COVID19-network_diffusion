...
write.table(difffusion_set_df, file = paste0(getwd(), "/Diffusion_permutation_scores3.txt"), sep = "\t", quote = F, row.names = FALSE, col.names = TRUE)